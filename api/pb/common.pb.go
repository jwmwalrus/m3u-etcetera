...
var file_api_pb_common_proto_rawDesc = []byte{
	0x0a, 0x13, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x62, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70,
...
var file_api_pb_common_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_pb_common_proto_goTypes = []interface{}{
...
func file_api_pb_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_pb_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
