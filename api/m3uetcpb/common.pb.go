...
// 	protoc        v3.12.4
// source: api/m3uetcpb/common.proto
...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_m3uetcpb_common_proto_msgTypes[0]
...
var File_api_m3uetcpb_common_proto protoreflect.FileDescriptor
...
var file_api_m3uetcpb_common_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x63, 0x70, 0x62, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x2a, 0x41,
	...
	0x4f, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x50, 0x4f, 0x44, 0x43, 0x41, 0x53, 0x54, 0x53, 0x10,
	0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x41, 0x55, 0x44, 0x49, 0x4f, 0x42, 0x4f, 0x4f, 0x4b, 0x53, 0x10,
	0x03, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x6d, 0x33, 0x75, 0x65, 0x74, 0x63, 0x70, 0x62, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_api_m3uetcpb_common_proto_rawDescOnce sync.Once
	file_api_m3uetcpb_common_proto_rawDescData = file_api_m3uetcpb_common_proto_rawDesc
)

func file_api_m3uetcpb_common_proto_rawDescGZIP() []byte {
	file_api_m3uetcpb_common_proto_rawDescOnce.Do(func() {
		file_api_m3uetcpb_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_m3uetcpb_common_proto_rawDescData)
	})
...
func init() { file_api_m3uetcpb_common_proto_init() }
func file_api_m3uetcpb_common_proto_init() {
	if File_api_m3uetcpb_common_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_m3uetcpb_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
	...
	file_api_m3uetcpb_common_proto_rawDesc = nil
	file_api_m3uetcpb_common_proto_goTypes = nil
	file_api_m3uetcpb_common_proto_depIdxs = nil
}
