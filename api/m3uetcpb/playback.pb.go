...
type GetPlaybackResponse struct {
	...
	//	*GetPlaybackResponse_Empty
	//	*GetPlaybackResponse_Playback
	//	*GetPlaybackResponse_Track
	Playing isGetPlaybackResponse_Playing `protobuf_oneof:"playing"`
}
...
func (m *GetPlaybackResponse) GetPlaying() isGetPlaybackResponse_Playing {
	if m != nil {
		return m.Playing
	}
	return nil
...
func (x *GetPlaybackResponse) GetEmpty() *Empty {
	if x, ok := x.GetPlaying().(*GetPlaybackResponse_Empty); ok {
		return x.Empty
	}
	return nil
}
...
func (x *GetPlaybackResponse) GetPlayback() *Playback {
	if x, ok := x.GetPlaying().(*GetPlaybackResponse_Playback); ok {
		return x.Playback
	}
	return nil
}
...
func (x *GetPlaybackResponse) GetTrack() *Track {
	if x, ok := x.GetPlaying().(*GetPlaybackResponse_Track); ok {
		return x.Track
	}
	return nil
}

type isGetPlaybackResponse_Playing interface {
	isGetPlaybackResponse_Playing()
}

type GetPlaybackResponse_Empty struct {
	Empty *Empty `protobuf:"bytes,1,opt,name=empty,proto3,oneof"`
}

type GetPlaybackResponse_Playback struct {
	Playback *Playback `protobuf:"bytes,2,opt,name=playback,proto3,oneof"`
}

type GetPlaybackResponse_Track struct {
	Track *Track `protobuf:"bytes,3,opt,name=track,proto3,oneof"`
}

func (*GetPlaybackResponse_Empty) isGetPlaybackResponse_Playing() {}

func (*GetPlaybackResponse_Playback) isGetPlaybackResponse_Playing() {}

func (*GetPlaybackResponse_Track) isGetPlaybackResponse_Playing() {}
...
type SubscribeToPlaybackResponse struct {
	...
	// Types that are assignable to Playing:
	//	*SubscribeToPlaybackResponse_Empty
	//	*SubscribeToPlaybackResponse_Playback
	//	*SubscribeToPlaybackResponse_Track
	Playing isSubscribeToPlaybackResponse_Playing `protobuf_oneof:"playing"`
}
...
func (m *SubscribeToPlaybackResponse) GetPlaying() isSubscribeToPlaybackResponse_Playing {
	if m != nil {
		return m.Playing
	}
	return nil
...
func (x *SubscribeToPlaybackResponse) GetEmpty() *Empty {
	if x, ok := x.GetPlaying().(*SubscribeToPlaybackResponse_Empty); ok {
		return x.Empty
	}
	return nil
}
...
func (x *SubscribeToPlaybackResponse) GetPlayback() *Playback {
	if x, ok := x.GetPlaying().(*SubscribeToPlaybackResponse_Playback); ok {
		return x.Playback
	}
	return nil
}
...
func (x *SubscribeToPlaybackResponse) GetTrack() *Track {
	if x, ok := x.GetPlaying().(*SubscribeToPlaybackResponse_Track); ok {
		return x.Track
	}
	return nil
}

type isSubscribeToPlaybackResponse_Playing interface {
	isSubscribeToPlaybackResponse_Playing()
}

type SubscribeToPlaybackResponse_Empty struct {
	Empty *Empty `protobuf:"bytes,1,opt,name=empty,proto3,oneof"`
}

type SubscribeToPlaybackResponse_Playback struct {
	Playback *Playback `protobuf:"bytes,2,opt,name=playback,proto3,oneof"`
}

type SubscribeToPlaybackResponse_Track struct {
	Track *Track `protobuf:"bytes,3,opt,name=track,proto3,oneof"`
}

func (*SubscribeToPlaybackResponse_Empty) isSubscribeToPlaybackResponse_Playing() {}

func (*SubscribeToPlaybackResponse_Playback) isSubscribeToPlaybackResponse_Playing() {}

func (*SubscribeToPlaybackResponse_Track) isSubscribeToPlaybackResponse_Playing() {}
...
var file_api_m3uetcpb_playback_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_api_m3uetcpb_playback_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_m3uetcpb_playback_proto_goTypes = []interface{}{
	...
	(*GetPlaybackResponse)(nil),          // 2: m3uetcpb.GetPlaybackResponse
	...
	(*Empty)(nil),                        // 5: m3uetcpb.Empty
	(*Track)(nil),                        // 6: m3uetcpb.Track
	(Perspective)(0),                     // 7: m3uetcpb.Perspective
}
var file_api_m3uetcpb_playback_proto_depIdxs = []int32{
	5,  // 0: m3uetcpb.GetPlaybackResponse.empty:type_name -> m3uetcpb.Empty
	1,  // 1: m3uetcpb.GetPlaybackResponse.playback:type_name -> m3uetcpb.Playback
	6,  // 2: m3uetcpb.GetPlaybackResponse.track:type_name -> m3uetcpb.Track
	0,  // 3: m3uetcpb.ExecutePlaybackActionRequest.action:type_name -> m3uetcpb.PlaybackAction
	7,  // 4: m3uetcpb.ExecutePlaybackActionRequest.perspective:type_name -> m3uetcpb.Perspective
	5,  // 5: m3uetcpb.SubscribeToPlaybackResponse.empty:type_name -> m3uetcpb.Empty
	1,  // 6: m3uetcpb.SubscribeToPlaybackResponse.playback:type_name -> m3uetcpb.Playback
	6,  // 7: m3uetcpb.SubscribeToPlaybackResponse.track:type_name -> m3uetcpb.Track
	5,  // 8: m3uetcpb.PlaybackSvc.GetPlayback:input_type -> m3uetcpb.Empty
	3,  // 9: m3uetcpb.PlaybackSvc.ExecutePlaybackAction:input_type -> m3uetcpb.ExecutePlaybackActionRequest
	5,  // 10: m3uetcpb.PlaybackSvc.SubscribeToPlayback:input_type -> m3uetcpb.Empty
	2,  // 11: m3uetcpb.PlaybackSvc.GetPlayback:output_type -> m3uetcpb.GetPlaybackResponse
	5,  // 12: m3uetcpb.PlaybackSvc.ExecutePlaybackAction:output_type -> m3uetcpb.Empty
	4,  // 13: m3uetcpb.PlaybackSvc.SubscribeToPlayback:output_type -> m3uetcpb.SubscribeToPlaybackResponse
...
func file_api_m3uetcpb_playback_proto_init() {
	...
	file_api_m3uetcpb_playback_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*GetPlaybackResponse_Empty)(nil),
		(*GetPlaybackResponse_Playback)(nil),
		(*GetPlaybackResponse_Track)(nil),
	}
	file_api_m3uetcpb_playback_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*SubscribeToPlaybackResponse_Empty)(nil),
		(*SubscribeToPlaybackResponse_Playback)(nil),
		(*SubscribeToPlaybackResponse_Track)(nil),
	}
	type x struct{}
